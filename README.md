...
Este proyecto es una representación 3D interactiva del ciclo biológico del *Agave tequilana Weber variedad azul*[cite: 1]. En lugar de un escenario genérico, la escena aísla una única planta central sobre su terreno, demostrando el uso de geometrías primitivas, agrupaciones jerárquicas y eventos de raycasting en **Three.js**.

## Cumplimiento de Requisitos
*   **Tema:** El proceso biológico de crecimiento del Agave azul[cite: 1].
*   **Geometrías Utilizadas (Mínimo 3):**
    *   **Esferas:** Modificadas mediante escalado para representar la *Piña*.
    *   **Cilindros:** Utilizados tanto para el terreno base como para representar el *Quiote*, un cilindro texturizado de hasta 5 metros de altura[cite: 1].
...
*   **Interacción y Lógica:** 
    ...
    *   **Controles UI:** El botón de "Simular Sequía" transiciona el color de las hojas, debido a que si se presenta sequía constante, la planta detiene su crecimiento y las pencas toman un tono rojizo[cite: 1].
    *   El suelo está renderizado con colores rojizos (simulando la tierra rica en hierro de Los Altos de Jalisco)[cite: 1].
